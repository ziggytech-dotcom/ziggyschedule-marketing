...
const reasons = [
  `Save money every month — Acuity Scheduling charges $20/mo. ZiggySchedule starts at $15/mo.`,
    ...
    <div className="bg-[#0a0a0a] min-h-screen" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-20 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <div className="inline-flex items-center gap-2 bg-[#1a1a1a] border border-[#2d2d2d] rounded-full px-4 py-1.5 text-sm text-[#b3b3b3] mb-8">ZiggySchedule vs Acuity Scheduling</div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            <span className="text-[#f472b6]">ZiggySchedule</span> vs <span className="text-[#b3b3b3]">Acuity Scheduling</span>
          </h1>
      ...
      <section className="py-16 px-4 bg-[#111111] border-y border-[#2d2d2d]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#1a1a1a] border border-[#2d2d2d] rounded-xl p-6">
            <p className="text-[#b3b3b3] leading-relaxed">Acuity Scheduling starts at $20/mo for 1 user and goes to $61/mo for multiple users. ZiggySchedule Pro includes 10 users at $35/mo with Twilio SMS and Stripe payments built in.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            ...
            <div className="bg-[#111111] border border-[#1f1f1f] rounded-2xl p-8 text-center">
              <p className="text-xl font-bold text-white mb-2">Acuity Scheduling</p>
          ...
          <div className="bg-[#111111] border border-[#1f1f1f] rounded-2xl overflow-hidden mb-16">
            <div className="grid grid-cols-3 bg-[#1a1a1a] border-b border-[#1f1f1f]">
              ...
              <div className="p-4 text-sm font-semibold text-[#b3b3b3] text-center">Acuity Scheduling</div>
            </div>
            {rows.map((r) => (
